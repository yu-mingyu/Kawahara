%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Codes for validated numerical solutions to the Kawahara equation
...
function [spec_out ] = convolution_product(a,power,f0,f1)
    ...
    % Go to grid space
    a_grid = verifyfft(a_shift_normalized,-1);
    
    % Apply nonlinearity
    a_nonlinear = a_grid.^power;
    
    % Return to coefficient space. 
    spec_all = verifyfft(a_nonlinear,1);
